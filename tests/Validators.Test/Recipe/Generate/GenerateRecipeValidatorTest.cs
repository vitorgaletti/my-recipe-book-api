...
public class GenerateRecipeValidatorTest
{
    ...
    public void Error_More_Maximum_Ingredient()
    {
        ...
        result.Errors.ShouldContain(e => e.ErrorMessage.Equals(ResourceMessagesException.INVALID_NUMBER_INGREDIENTS));
    }
    ...
    public void Error_Duplicated_Ingredient()
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors.ShouldContain(e => e.ErrorMessage.Equals(ResourceMessagesException.DUPLICATED_INGREDIENTS_IN_LIST));
    }
    ...
    public void Error_Ingredient_Not_Following_Pattern()
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors.ShouldContain(e => e.ErrorMessage.Equals(ResourceMessagesException.INGREDIENT_NOT_FOLLOWING_PATTERN));
    }
}